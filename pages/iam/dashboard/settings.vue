<template>
  <div>
    ...
    <p class="lead">Modifica le tue impostazioni</p>
    <div class="row">
      <div class="col">
      ...
      <div class="col">
        <div class="card mb-3 mx-10 my-10" style="max-width: 25rem">
          ...
          <div class="card-body">
            <h5 class="card-title text-danger">Cancella account</h5>
            <!-- Profile errors notification -->
            <div
              v-if="deleteError"
              class="alert alert-danger alert-dismissible fade show"
            ...
            <p>
              Attenzione! Cancellare il tuo account è un'operazione permanente e definitiva.
              Se sei sicuro di voler cancellare il tuo account, premi il bottone qui sotto.
            </p>
            <button
              type="submit"
