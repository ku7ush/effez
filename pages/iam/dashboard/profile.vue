<template>
  <div>
    <h1 class="mt-5">Profilo Utente</h1>
    <p class="lead"></p>
  </div>
  ...
  <div class="row">
      <div class="col">
        <div class="card mb-3 mx-10" style="max-width: 25rem">
          <h4 class="card-header">Profilo</h4>
          <div class="card-body">
            <h5 class="card-title">Aggiorna Profilo</h5>
            <p></p>
            <!-- Data here-->
            <form class="mb-5">
              <div class="mb-3">
                ...
                <input
                  ...
                  disabled
                />
                <label for="is_active" class="form-label">Profilo attivo</label>
                <input
                  type="text"
                  class="form-control mb-3"
                  id="is_active"                  
