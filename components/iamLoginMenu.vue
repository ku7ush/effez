  ...
  <div class="d-flex align-items-center" v-else>         
    <div class="dropdown text-end" @click="toggleMenu">
      ...
      > 
        ...
        <li><NuxtLink class="dropdown-item" to="/iam/dashboard/profile">Profilo</NuxtLink></li>
        <li><NuxtLink class="dropdown-item" to="/iam/dashboard/ordini">Ordini</NuxtLink></li>
        <li><NuxtLink class="dropdown-item" to="/iam/dashboard/preventivi">Preventivi</NuxtLink></li>
        <li><NuxtLink class="dropdown-item" to="/iam/dashboard/settings">Impostazioni</NuxtLink></li>        
